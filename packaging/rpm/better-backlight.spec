...
sed -i '1s|^|#!/opt/better-backlight/venv/bin/python\n|' %{buildroot}/opt/better-backlight/better_backlight/daemon.py
...
# Fresh install, let's create virtualenv and create necessary symlinks
if [ $1 -eq 1 ]; then
    python3 -m venv /opt/better-backlight/venv
    ln -s /opt/better-backlight/better_backlight/daemon.py /opt/better-backlight/bin/better-backlight
